                ...
                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-auto">
                    ...
                    <span className="mr-auto"><i>icon</i> in person event</span>
                        ...
                        <div className="flex-banner-top">
                            <div className="attendees-info"><i><img src={process.env.PUBLIC_URL + "/event/attendence.png"} alt="Attendee Profile" /></i>300 Attendees</div>
                            <div className="event-info"><i><img src={process.env.PUBLIC_URL + "/event/video.png"} alt="Event info" /></i> in Person Event</div>
                        </div>
